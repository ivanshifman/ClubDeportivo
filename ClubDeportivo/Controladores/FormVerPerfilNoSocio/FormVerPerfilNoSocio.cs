...
namespace ClubDeportivo.Controladores.FormVerPerfilNoSocio
{
    public partial class frmVerPerfilNoSocio : Form
    {
        ...
        private void txtNombrePerfilNoSocio_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtApellidoPerfilNoSocio_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsLetter(e.KeyChar) && !char.IsControl(e.KeyChar) && !char.IsWhiteSpace(e.KeyChar))
            {
                e.Handled = true;
